<?php
	$adresa="386 Pennsylvania Ave., Ste 1 North, Glen Ellyn, IL 60137"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=6308582198;// Broj koji se poziva na dugme CALL US
